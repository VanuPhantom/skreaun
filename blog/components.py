...
from htpy import Element, HTMLElement, a, body, h1, h2, html, li, main, p, ul, head, link
...
def wrapper(*children: list[Element]) -> HTMLElement:
    return html[head[
        link(rel="stylesheet", href=static("/blog/stylesheet.css"))], body[h1["Vanu's blog"], *children]
    ]
